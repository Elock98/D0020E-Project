...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} run --rm -v /home/emilo/Documents/d0020e/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/org1/msp organizations/fabric-ca/org1/tls-cert.pem organizations/fabric-ca//ca-cert.pem organizations/fabric-ca/org1/IssuerPublicKey organizations/fabric-ca/1/IssuerRevocationPublicKey organizations/fabric-ca/org1/fabric-ca-server.db

    ${CONTAINER_CLI} run --rm -v /home/emilo/Documents/d0020e/D0020E-Project/src/network:/data busybox sh -c cd /data && rm -rf organizations/fabric-ca/org2/msp organizations/fabric-ca/org2/tls-cert.pem organizations/fabric-ca//ca-cert.pem organizations/fabric-ca/org2/IssuerPublicKey organizations/fabric-ca/2/IssuerRevocationPublicKey organizations/fabric-ca/org2/fabric-ca-server.db
    #repeatX##removeOrg#
